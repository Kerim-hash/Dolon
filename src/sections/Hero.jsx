          ...
          <div ref={sectionRef} className="scroll-section-inner">
            ...
            >
              <div className={`${styles.info} max-[600px]:mb-[30px]`}>
                ...
                <motion.div variants={textVariant(0.2)}>
                  <p className={styles.infoDesc}>
                    &quot;Долон&quot; обеспечивает высокую точность привязки
                    результатов аналитики к соответствующим данным, исключая
                    возможность ошибок и искажений информации. Сократив
                    количество времени для выполнения этой задачи, вы освободите
                    его для других важных задач, повышая общую
                    производительность и эффективность работы на руднике.&quot;
                  </p>
            ...
            >
              <div className={`${styles.info} max-[600px]:mb-[30px]`}>
                ...
                <motion.div variants={textVariant(0.2)}>
                  <p className={styles.infoDesc}>
                    &quot; Система &quot;Долон&quot; надежный помощник в сборе и
                    систематизации данных геологоразведочных работ. Теперь
                    главный геолог может контролировать весь процесс сбора
                    данных дистанционно, без необходимости быть на месте.&quot;
                  </p>
                  <a href="#Contacts" className={styles.button}>
                    Получить экспертную консультацию
                  </a>
